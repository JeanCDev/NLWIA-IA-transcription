...
type VideoInputFormProps = {
  setVideoId: (template: string) => void;
}
...
const VideoInputForm = ({
  ...
  const previewUrl = useMemo(() => !video ? null : URL.createObjectURL(video), [video]);
  ...
  return (
    <form className="space-y-6" onSubmit={handleUploadVideo}>
      ...
      >
        {
          previewUrl
          ? <video src={previewUrl} controls={false} className="pointer-event-none relative inset-0"/>
